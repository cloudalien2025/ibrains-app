...
const BASE_FIELDS: WalmartSearchBrowseFieldDefinition[] = [
  ...
  },
  {
    ...
    type: "textarea",
    group: "audience_usage",
    placeholder: "Adults take as directed on the product label.",
  },
  {
  ...
  {
    key: "count_per_package",
    label: "Count Per Package",
    type: "text",
    group: "dimensions_packaging",
    placeholder: "1",
    helperText: "Legacy alias for count per pack.",
  },
  {
  ...
  },
  {
    ...
    type: "multi-select",
    group: "search_browse_metadata",
    placeholder: "ingredient + use-case keywords",
  },
  {
    key: "search_terms",
    label: "Search Terms",
    type: "multi-select",
    group: "search_browse_metadata",
    placeholder: "long-tail shopper phrases",
  },
  {
    key: "category",
    label: "Category",
...
const SUPPLEMENT_FIELDS: WalmartSearchBrowseFieldDefinition[] = [
  ...
  },
  {
    ...
    type: "text",
    group: "product_identity",
    placeholder: "Sleep Support Supplement",
  },
  {
    key: "product_name",
    label: "Product Name",
    type: "text",
    group: "product_identity",
    placeholder: "Magnesium Glycinate Gummies",
  },
  {
    key: "product_form",
    label: "Product Form",
  ...
  },
  {
    ...
    group: "ingredients_form",
    placeholder: "Gummy",
    helperText: "Legacy alias for product form.",
  },
  {
    key: "flavor",
    label: "Flavor",
...
const KEY_ALIASES: Record<string, string> = {
  ...
  countperpackage: "count_per_package",
