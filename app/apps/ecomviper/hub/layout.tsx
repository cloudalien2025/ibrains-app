...
import HubSidebar from "@/app/apps/ecomviper/hub/_components/hub-sidebar";

export const dynamic = "force-dynamic";

export default function HubLayout({ children }: { children: ReactNode }) {
  return (
    <main className="mx-auto max-w-[1320px] px-4 py-6 sm:px-6" data-testid="ecomviper-hub-layout">
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="inline-flex items-center rounded-full border border-[#D9E4F0] bg-white/90 px-3 py-1 text-xs text-[#475569]">
          Canonical Intelligence Control Plane
        </div>
      </div>
