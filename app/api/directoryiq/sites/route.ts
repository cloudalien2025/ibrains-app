...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    let listingsDataId = asNumber(body.listings_data_id ?? body.listingsDataId);
    let blogPostsDataId = asNumber(body.blog_posts_data_id ?? body.blogPostsDataId);
    ...
    let listingsPath = requestedListingsPath || "/api/v2/users_portfolio_groups/search";
    let blogPostsPath = requestedBlogPostsPath || null;
