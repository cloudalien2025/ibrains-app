...
export async function POST(
  ...
  try {
    ...
    const resolvedFocusTopic = focusTopic || sourcePost?.focus_topic?.trim() || sourcePost?.title?.trim() || detail.listing.title || resolvedListingId;
    ...
    const altText = `${resolvedFocusTopic} featured image`;
