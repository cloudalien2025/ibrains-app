...
export default function SiteForgeSidebar() {
  ...
  return (
    <aside
      ...
      aria-label="PageBolt command center sidebar"
      data-testid="siteforge-command-center-sidebar"
    >
      <div className="mb-3 border-b border-[#E2E8F0] pb-3">
        <p className="text-[11px] uppercase tracking-[0.16em] text-[#64748B]">PAGEBOLT</p>
      ...
      <nav aria-label="PageBolt command center navigation" className="grid gap-1" data-testid="siteforge-command-center-nav">
      ...
      <div className="mt-3 rounded-lg border border-dashed border-[#D9E4F0] bg-[#F8FBFF] p-3">
        ...
        <p className="mt-1 text-xs text-[#475569]">
          This shell frames existing PageBolt workflows only. Build and publishing behavior remains unchanged.
        </p>
      </div>
    </aside>
  );
