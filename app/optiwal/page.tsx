...
interface WalmartDashboardConnectionUi {
  ...
  connected: boolean;
  primaryActionLabel: "Connect OptiWal" | "Manage OptiWal Connection";
  primaryActionHref: "/optiwal/connect";
...
export function buildWalmartDashboardConnectionUi(
  ...
  return {
    badgeLabel,
    connected,
    primaryActionLabel: connected ? "Manage OptiWal Connection" : "Connect OptiWal",
    primaryActionHref: "/optiwal/connect",
...
export default async function WalmartDashboardPage() {
  ...
  return (
    <div className="space-y-4" data-testid="ecomviper-walmart-dashboard">
      <WalmartPageHeader
        title="OptiWal Marketplace Command Center"
                ...
                {!snapshot.recentProducts.length ? (
                  <tr className="border-t border-[#E2E8F0]">
                    <td colSpan={4} className="py-6 text-center text-sm text-[#64748B]">
                      No OptiWal products imported yet. Connect OptiWal, then import your products.
                    </td>
                  </tr>
                ) : null}
              </tbody>
