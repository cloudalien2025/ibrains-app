...
const hubSidebarItems = [
  { label: "Overview", href: "/ecomviper/hub#overview" },
  { label: "Feed Control Center", href: "/ecomviper/hub#feed-control-center" },
  { label: "Canonical Product Manager", href: "/ecomviper/hub#canonical-product-manager" },
  { label: "Agentic Visibility", href: "/ecomviper/hub#agentic-visibility" },
  { label: "Marketplace Routing", href: "/ecomviper/hub#marketplace-routing" },
  { label: "Trust & Verification", href: "/ecomviper/hub#trust-and-verification" },
  { label: "Operations", href: "/ecomviper/hub#operator-workflows" },
  { label: "Roadmap", href: "/ecomviper/hub#roadmap" },
] as const;
