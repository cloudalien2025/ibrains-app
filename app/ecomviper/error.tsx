...
export default function EcomViperError({
  error,
  reset,
}: {
  ...
  return (
    <div className="mx-auto mt-8 max-w-3xl rounded-2xl border border-rose-200 bg-white p-6 shadow-[0_16px_36px_rgba(15,23,42,0.08)]">
      <p className="text-xs uppercase tracking-[0.16em] text-rose-600">EcomViper Error</p>
      <h2 className="mt-2 text-xl font-semibold text-[#0F172A]">EcomViper failed to load</h2>
      <p className="mt-2 text-sm text-[#334155]">
        This workspace encountered an unexpected runtime error. Retry render or return to the launcher.
      </p>
