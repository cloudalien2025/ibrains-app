...
export default function EcomViperDashboardClient({
  ...
  return (
    <div className="space-y-3" data-testid="ecomviper-overview-page">
      <section className="rounded-2xl border border-[#D2E3F8] bg-white p-4" data-testid="ecomviper-workspace-status-row">
        <div className="mb-3 flex items-center justify-between gap-3">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[#1D4ED8]">EcomViper</p>
            <h1 className="text-lg font-semibold text-[#0F172A]">Products Workspace</h1>
          </div>
          <span className="rounded-full border border-[#D2E3F8] bg-[#F5FAFF] px-3 py-1 text-xs text-[#334155]">
            Shopify operations console
          </span>
        </div>
      ...
      <section
        ...
        className="rounded-2xl border border-[#D2E3F8] bg-white p-4"
