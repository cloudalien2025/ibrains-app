...
describe("admin ecomviper routes contract", () => {
  beforeEach(() => {
    ...
    mocks.getRocktomicAdminAuditViewModel.mockResolvedValue({
      ...
      ocrNeedsReviewSkuCount: 96,
      aiTextFactsCoverage: { field: "coverage", requiredSkuCount: 156, presentSkuCount: 24, missingSkuCount: 132, coveragePercent: 15.4 },
      ocrFactsCoverage: { field: "coverage", requiredSkuCount: 156, presentSkuCount: 0, missingSkuCount: 156, coveragePercent: 0 },
      supplementFactsCoverageTotal: { field: "coverage", requiredSkuCount: 156, presentSkuCount: 24, missingSkuCount: 132, coveragePercent: 15.4 },
      aiLabelTextExtractionAttempted: 119,
      aiLabelTextExtractionSucceeded: 24,
      aiLabelTextNeedsReview: 24,
      aiLabelTextNonPdfCompatible: 0,
      aiLabelTextNoExtractableText: 95,
